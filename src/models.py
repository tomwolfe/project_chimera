...
class ContextAnalysisOutput(BaseModel):
    ...
    security_summary: Optional[Dict[str, Any]] = Field(None, alias="security_summary", description="Summary tailored for Security_Auditor, including problem snippets.")
    architecture_summary: Optional[Dict[str, Any]] = Field(None, alias="architecture_summary", description="Summary tailored for Code_Architect, including problem snippets.")
    devops_summary: Optional[Dict[str, Any]] = Field(None, alias="devops_summary", description="Summary tailored for DevOps_Engineer, including problem snippets.")
    testing_summary: Optional[Dict[str, Any]] = Field(None, alias="testing_summary", description="Summary tailored for Test_Engineer, including problem snippets.")
