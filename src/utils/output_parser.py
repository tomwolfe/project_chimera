...
# --- The following functions are helpers for the parser, not directly called by the main app flow ---
# --- but are part of the parser's internal logic for robust extraction and repair ---
