...
class PromptOptimizer:
    ...
    def _summarize_text(self, text: str, target_tokens: int) -> str:
        ...
        try:
            ...
            DISTILBART_MAX_OUTPUT_TOKENS = 256 # A reasonable cap for distilbart-cnn-6-6
            ...
            summarizer_internal_max_output_tokens = min(target_tokens, DISTILBART_MAX_OUTPUT_TOKENS)
