...
def test_debate_orchestrator_initialization():
    ...
    orchestrator = SocraticDebate(
        initial_prompt="test", api_key="mock_key", model_name="gemini-2.5-flash-lite",
        persona_manager=mock_persona_manager, settings=MagicMock(),
        structured_codebase_context={}, raw_file_contents={}
    )
