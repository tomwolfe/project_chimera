...
def test_self_improvement_analyzer_initialization(mock_metrics_collector, mock_prompt_engineer, mock_llm_provider):
...
def test_analyze_self_improvement_plan_success(mock_metrics_collector, mock_prompt_engineer, mock_llm_provider):
    ...
    mock_prompt_engineer.generate_self_improvement_prompt.return_value = "Analyze performance metrics and suggest improvements."
    ...
    mock_llm_provider.generate_content.assert_called_once_with("Analyze performance metrics and suggest improvements.")
    mock_prompt_engineer.generate_self_improvement_prompt.assert_called_once()

def test_analyze_self_improvement_plan_api_error(mock_metrics_collector, mock_prompt_engineer, mock_llm_provider):
...
def test_analyze_self_improvement_plan_parsing_error(mock_metrics_collector, mock_prompt_engineer, mock_llm_provider):
